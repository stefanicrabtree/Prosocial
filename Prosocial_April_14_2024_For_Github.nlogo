...
to assess_fitness
  ...
  if [pennies] of top-neighbor <= pennies
  [
    ; do nothing
  ]
...
<experiments>
  ...
  <experiment name="March_15_despot_04" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_moredefect1" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_moredefect2" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_moremonitor1" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_moremonitor2" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_size" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_moredefect3" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_agentpops_moremonitor3" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="Apr_14_influencer" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="April_9_2024_influencer_04_sanct" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="April_09_copy_defector_ps_90" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="April_14_mm_1_5_prob_sanc_90_tax_05" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="March_5_mm_only_PGG_2_sanction_tax_1_75" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="March_6_mm_only_PGG_2_sanction_tax_sweep" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="March_5_mm_only_PGG_2_sanction_tax_100" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="March_5_mm_only_PGG_2_sanction_tax_0_75" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
  ...
  <experiment name="March_5_mm_only_PGG_2_sanction_tax_0_50" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [label = "M"]</metric>
