...
penp_despot = penny_plot3 + xlab("Global Leader, Probability Sanction 40%") + ylab("Pennies")
...
png(file="Despot_to_Copy_Defector_zoomed.png", height=10, width=5, units="in", res=600)
par(mar=c(4.5,4.5,1.5,1.2))
par(oma=c(0,0,0,0))
plot_grid(ppD, ppD2, pppL40, ppL90, nrow=4, ncol = 1, labels=c('\n a.', '\n b.', '\n c.', '\n d.'), label_size=10, align="v")
dev.off()
